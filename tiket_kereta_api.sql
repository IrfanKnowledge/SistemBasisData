...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 04, 2018 at 12:05 PM
...
(1, 'Malabar', '1', 'Eksekutif'),
(2, 'Malabar', '2', 'Eksekutif'),
(3, 'Malabar', '3', 'Bisnis'),
(4, 'Malabar', '4', 'Bisnis'),
(5, 'Malabar', '5', 'Ekonomi');
...
INSERT INTO `harga` (`ID`, `id_jadwal`, `harga_tiket`) VALUES
(1, 1, 360000),
(2, 2, 360000),
(3, 3, 270000),
(4, 4, 270000),
...
INSERT INTO `jadwal` (`ID`, `id_gerbong`, `tgl_keberangkatan`, `kd_stasiun_keberangkatan`, `kd_stasiun_tujuan`, `waktu_berangkat`, `waktu_tiba`, `status`) VALUES
(1, 1, '2018-12-05', 'ML', 'BD', '16:00:00', '07:48:00', 'Tersedia'),
(2, 2, '2018-12-05', 'ML', 'BD', '16:00:00', '07:48:00', 'Tersedia'),
(3, 3, '2018-12-05', 'ML', 'BD', '16:00:00', '07:48:00', 'Tersedia'),
(4, 4, '2018-12-05', 'ML', 'BD', '16:00:00', '07:48:00', 'Tersedia'),
(5, 5, '2018-12-05', 'ML', 'BD', '16:00:00', '07:48:00', 'Tersedia');
...
CREATE TABLE `pemesanan` (
  ...
  `id_jadwal` int(1) UNSIGNED DEFAULT NULL,
  `id_harga` int(1) UNSIGNED DEFAULT NULL,
  `id_gerbong` int(1) UNSIGNED DEFAULT NULL,
  `jumlah_tiket_dewasa` tinyint(1) UNSIGNED NOT NULL,
  `jumlah_tiket_bayi` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `total_harga` mediumint(1) UNSIGNED DEFAULT NULL,
...
INSERT INTO `pemesanan` (`ID`, `kd_pembeli_customer`, `kd_pembeli_anonim`, `tgl_pemesanan`, `id_jadwal`, `id_harga`, `id_gerbong`, `jumlah_tiket_dewasa`, `jumlah_tiket_bayi`, `total_harga`, `status`, `kode_booking`) VALUES
(1, 'ridjalzuhri@gmail.com', 'ahmadmaulana@gmail.com', '2018-12-05 10:00:00', NULL, 1, 1, 1, 0, 360000, 'Proses', 'KB0001'),
(2, 'mfurqan@gmail.com', 'irfanmuhammad@gmail.com', '2018-12-05 07:00:00', NULL, 3, 3, 2, 0, 540000, 'Proses', 'KB0002');
...
ALTER TABLE `gerbong`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `fk_kd_kereta_gerbong` (`kd_kereta`);
...
ALTER TABLE `harga`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `fk_id_jadwal_harga` (`id_jadwal`);
...
ALTER TABLE `jadwal`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `fk_id_gerbong_jadwal` (`id_gerbong`),
  ADD KEY `fk_kd_stasiun_keberangkatan_jadwal` (`kd_stasiun_keberangkatan`),
  ADD KEY `fk_kd_stasiun_tujuan_jadwal` (`kd_stasiun_tujuan`);
...
ALTER TABLE `konfirmasi`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `fk_id_pemesanan_konfirmasi` (`id_pemesanan`),
  ADD KEY `fk_id_admin_konfirmasi` (`id_admin`);
...
ALTER TABLE `kursi`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `fk_id_gerbong_kursi` (`id_gerbong`);
...
ALTER TABLE `pemesanan`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `tgl_pemesanan_3` (`tgl_pemesanan`),
  ADD KEY `fk_kd_pembeli_customer_pemesanan` (`kd_pembeli_customer`),
  ADD KEY `fk_kd_pembeli_anonim_pemesanan` (`kd_pembeli_anonim`),
  ADD KEY `fk_id_harga_pemesanan` (`id_harga`),
  ADD KEY `fk_kd_id_gerbong_pemesanan` (`id_gerbong`),
  ADD KEY `tgl_pemesanan` (`tgl_pemesanan`),
  ADD KEY `tgl_pemesanan_2` (`tgl_pemesanan`),
...
ALTER TABLE `stasiun`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `kd_stasiun` (`kd_stasiun`);
...
ALTER TABLE `tiket`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `fk_id_pemesanan_tiket` (`id_pemesanan`),
  ADD KEY `fk_id_kursi_tiket` (`id_kursi`);
...
--
ALTER TABLE `kursi`
  MODIFY `ID` int(1) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=433;
...
ALTER TABLE `pemesanan`
  ...
  ADD CONSTRAINT `pemesanan_ibfk_1` FOREIGN KEY (`id_jadwal`) REFERENCES `jadwal` (`ID`);
